...
class Restoration(nn.Module):
    ...
    def __init__(self, 
        ...
        self.encoder_event_3 = EN_Trans_Block_Evs(self.channels[1], self.channels[2], heads[2], ffn_expansion_factor=ffn_expansion_factor, LayerNorm_type=LayerNorm_type, bias=bias )
        self.encoder_event_4 = EN_Trans_Block_Evs(self.channels[2], self.channels[3], heads[3], ffn_expansion_factor=ffn_expansion_factor, LayerNorm_type=LayerNorm_type, bias=bias )
...
if __name__ == "__main__":
    ...
    Total MACs: 124.55 G, Params: 15.17 M + event_encoder之后 【64 64 128 128】
    Total MACs: 175.20 G, Params: 18.40 M [64, 128, 128, 256]
